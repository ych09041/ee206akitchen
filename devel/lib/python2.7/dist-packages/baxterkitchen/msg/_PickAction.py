...
"""autogenerated by genpy from baxterkitchen/PickAction.msg. Do not edit."""
import sys
...
class PickAction(genpy.Message):
  _md5sum = "8fd8fb2cf97b84570677f220a74616e7"
  _type = "baxterkitchen/PickAction"
...
"""
  ...
  _slot_types = ['baxterkitchen/PickActionGoal','baxterkitchen/PickActionResult','baxterkitchen/PickActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = baxterkitchen.msg.PickActionGoal()
      if self.action_result is None:
        self.action_result = baxterkitchen.msg.PickActionResult()
      if self.action_feedback is None:
        self.action_feedback = baxterkitchen.msg.PickActionFeedback()
    else:
      self.action_goal = baxterkitchen.msg.PickActionGoal()
      self.action_result = baxterkitchen.msg.PickActionResult()
      self.action_feedback = baxterkitchen.msg.PickActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3f3I.pack(_x.action_goal.goal.p_x, _x.action_goal.goal.p_y, _x.action_goal.goal.p_z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_result.result.done, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3f.pack(_x.action_feedback.feedback.fb_x, _x.action_feedback.feedback.fb_y, _x.action_feedback.feedback.fb_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.p_x, _x.action_goal.goal.p_y, _x.action_goal.goal.p_z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.done, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.fb_x, _x.action_feedback.feedback.fb_y, _x.action_feedback.feedback.fb_z,) = _struct_3f.unpack(str[start:end])
      return self
