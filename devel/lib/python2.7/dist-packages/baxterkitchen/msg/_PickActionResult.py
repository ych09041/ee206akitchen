...
"""autogenerated by genpy from baxterkitchen/PickActionResult.msg. Do not edit."""
import sys
...
class PickActionResult(genpy.Message):
  _md5sum = "b9707e0431b9a81c052a6b0185503a92"
  _type = "baxterkitchen/PickActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','baxterkitchen/PickResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = baxterkitchen.msg.PickResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = baxterkitchen.msg.PickResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.result.done))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.done,) = _struct_i.unpack(str[start:end])
      return self
