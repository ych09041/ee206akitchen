...
class MoveAction(object):
    ...
    _feedback = baxterkitchen.msg.MoveFeedback()
    _result   = baxterkitchen.msg.MoveResult()

    def __init__(self, name):
        self._action_name = name
        self._as = actionlib.SimpleActionServer(self._action_name, baxterkitchen.msg.MoveAction, execute_cb=self.execute_cb, auto_start = False)
        self._as.start()
